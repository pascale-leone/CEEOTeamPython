...
class doubleMotor(le.DoubleMotor):
    ...
    def run_left_motor(self, rotations=1):
    ...
    def set_speed(self, speed):
        ...
        '''
        dm.motor_set_speed(speed, motor=le.MOTOR_LEFT)   
        dm.motor_set_speed(speed, motor=le.MOTOR_RIGHT)   
        dm.movement_set_speed(speed)
